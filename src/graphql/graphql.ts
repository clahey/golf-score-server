...
export type GetGamesQuery = { __typename?: 'Query', games: Array<{ __typename?: 'Game', id: string, description: string, participants: Array<{ __typename?: 'PlayerWithScores', player?: { __typename?: 'Player', name: string } | null }> }> };
